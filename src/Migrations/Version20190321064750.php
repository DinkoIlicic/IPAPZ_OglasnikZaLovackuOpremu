 ...
 */
final class Version20190321064750 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coupon_codes ADD category_id INT NOT NULL, ADD product_id INT NOT NULL, DROP date_enabled, DROP start_date, DROP expire_data, DROP category, DROP product');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE coupon_codes ADD date_enabled INT NOT NULL, ADD start_date DATETIME NOT NULL, ADD expire_data DATETIME NOT NULL, ADD category INT NOT NULL, ADD product INT NOT NULL, DROP category_id, DROP product_id');
    }
}
